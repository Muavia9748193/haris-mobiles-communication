...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ SIRF ADMIN ALLOWED - CHANGE EMAIL HERE
      if (formData.email === 'muaviaabbas9748193@gmail.com') {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="muaviaabbas9748193@gmail.com"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-blue-500/30 transition hover:scale-[1.02] disabled:opacity-50"
          >
